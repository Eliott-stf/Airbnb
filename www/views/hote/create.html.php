        ...
        <form method="POST" action="/hote/create" enctype="multipart/form-data" class="space-y-6 ">
            ...
            <div class="flex gap-5">
                <div class="flex-1">
                    ...
                    <input type="date" value="<?= htmlspecialchars($old['date_in'] ?? '') ?>" id="date_in" name="date_in" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                </div>

                <div class="flex-1">
                    <label for="date_out" class="block text-sm font-medium text-gray-700 mb-1">Fin de location</label>
                    <input type="date" value="<?= htmlspecialchars($old['date_out'] ?? '') ?>" id="date_out" name="date_out" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                </div>
            </div>
